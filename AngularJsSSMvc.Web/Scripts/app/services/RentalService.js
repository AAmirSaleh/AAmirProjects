...
//    myAppModule.factory('RentalService', ['BicyclesService', 'CustomersService', function (bicyclesService, customersService) {
//        var bicycles = bicyclesService.getBicycles();
//        console.log(bicycles);
        
//        //console.log(bicycles[0].id);
...
//                { id: 2, startDate: moment().startOf('day').weekday(1).toDate(), endDate: moment().startOf('day').weekday(2).toDate(), /*bicycleId: bicycles[1].id,*/ bicycle: bicycles[1], quantity: 1, totalPrice: 1 * bicycles[1].rentPrice, paid: true, customerId: customers[1].id, customer: customers[1] }
//        ];
...
//                throw new Error('rental start data cannot be greater the rental end date!');
//        };
...
(function () {
    ...
    myAppModule.factory('RentalService', [
